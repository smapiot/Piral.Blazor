...
[![Nuget](https://img.shields.io/badge/nuget-v7.0.6-blue)](https://www.nuget.org/packages/Piral.Blazor.Template/7.0.7)
...
- Run `dotnet new install Piral.Blazor.Template::7.0.7` to install the project template globally.
