...
[![Nuget](https://img.shields.io/badge/nuget-v9.0.18-blue)](https://www.nuget.org/packages/Piral.Blazor.Template/9.0.18)
...
- Make sure that [.NET 9 SDK](https://dotnet.microsoft.com/download/dotnet/9.0) is installed.
- Run `dotnet new install Piral.Blazor.Template::9.0.18` to install the project template globally.
