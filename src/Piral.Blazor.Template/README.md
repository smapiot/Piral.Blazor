...
[![Nuget](https://img.shields.io/badge/nuget-v9.0.19-blue)](https://www.nuget.org/packages/Piral.Blazor.Template/9.0.19)
...
- Run `dotnet new install Piral.Blazor.Template::9.0.19` to install the project template globally.
