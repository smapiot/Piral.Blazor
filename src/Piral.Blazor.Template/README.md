...
[![Nuget](https://img.shields.io/badge/nuget-v9.0.17-blue)](https://www.nuget.org/packages/Piral.Blazor.Template/9.0.17)
...
- Run `dotnet new install Piral.Blazor.Template::9.0.17` to install the project template globally.
