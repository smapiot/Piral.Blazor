...
[![Nuget](https://img.shields.io/badge/nuget-v5.0.0-blue)](https://www.nuget.org/packages/Piral.Blazor.Template/5.0.0)
...
- Run `dotnet new --install Piral.Blazor.Template::5.0.0` to install the project template globally.
