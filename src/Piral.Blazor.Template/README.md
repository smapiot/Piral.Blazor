...
[![Nuget](https://img.shields.io/badge/nuget-v6.0.6-blue)](https://www.nuget.org/packages/Piral.Blazor.Template/6.0.6)
...
- Run `dotnet new install Piral.Blazor.Template::6.0.6` to install the project template globally.
