...
[![Nuget](https://img.shields.io/badge/nuget-v6.0.1-blue)](https://www.nuget.org/packages/Piral.Blazor.Template/6.0.1)
...
- Run `dotnet new --install Piral.Blazor.Template::6.0.1` to install the project template globally.
