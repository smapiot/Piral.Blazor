...
[![Nuget](https://img.shields.io/badge/nuget-v10.0.19-blue)](https://www.nuget.org/packages/Piral.Blazor.Template/10.0.19)
...
- Make sure that [.NET 9 SDK](https://dotnet.microsoft.com/download/dotnet/10.0) is installed.
- Run `dotnet new install Piral.Blazor.Template::10.0.19` to install the project template globally.
