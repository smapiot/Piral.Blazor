...
[![Nuget](https://img.shields.io/badge/nuget-v7.0.8-blue)](https://www.nuget.org/packages/Piral.Blazor.Template/7.0.8)
...
- Run `dotnet new install Piral.Blazor.Template::7.0.8` to install the project template globally.
