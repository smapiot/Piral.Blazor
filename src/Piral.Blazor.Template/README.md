...
[![Nuget](https://img.shields.io/badge/nuget-v8.0.14-blue)](https://www.nuget.org/packages/Piral.Blazor.Template/8.0.14)
...
- Run `dotnet new install Piral.Blazor.Template::8.0.14` to install the project template globally.
